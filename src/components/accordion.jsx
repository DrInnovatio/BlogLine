    ...
    <div style={ { width: '55rem' } }>
      <Accordion>
        ...
        <AccordionDetails style={styles.main}>
          ...
          <p>※ 동의를 거부할 권리가 있으나, 위 사항에 동의하지 않을 경우 견적 상담이 불가합니다.
            회사가 ㈜오토다이렉트카(http://autodirectcar.com)을 통하여 제공하는 서비스를 고객님이
            이용하도록 하기 위해서 그 수집 및 이용이 필요한 최소한의 개인정보이므로 해당 항목에
            동의를 해 주셔야 서비스 이용이 가능합니다.</p>
        </AccordionDetails>
      </Accordion>
      {/*<Accordion>
        <AccordionSummary
